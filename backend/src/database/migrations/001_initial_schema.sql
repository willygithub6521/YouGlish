...
-- Creates videos and subtitles tables with proper indexes and relationships
...
CREATE INDEX idx_subtitles_text ON subtitles USING gin(to_tsvector('english', text));
